    ...
    return (
        <div className="relative z-10">
            <div className='flex justify-between py-5 px-10 items-center'>
                <h1 className={`text-3xl font-bold ${color}`}>TWICE</h1>
            ...
            {isOpen && (
                <div className="fixed bg-white inset-0 overflow-hidden">
                    <div className='flex justify-between py-5 px-10 items-center'>
                        <h1 className='text-3xl font-bold'>TWICE</h1>
                    ...
                    <div className='flex justify-center items-center h-[80vh] mx-auto'>
                        <div className='flex flex-col space-y-2'>
                            <a href="/perfil/" className='text-5xl font-bold tracking-tight animate-fade-down'>Perfil</a>
                            <a href="/galeria/" className='text-5xl font-bold tracking-tight animate-fade-down'>Discografia</a>
                            <a href="/galeria/" className='text-5xl font-bold tracking-tight animate-fade-down'>Galeria</a>
                            <a href="#" className='text-5xl font-bold tracking-tight animate-fade-down'>Acerca de</a>
                        </div>
